...
from bot import Interval, INDEX_URL, VIEW_LINK, BUTTON_FOUR_NAME, BUTTON_FOUR_URL, BUTTON_FIVE_NAME, BUTTON_FIVE_URL, \
                BUTTON_SIX_NAME, BUTTON_SIX_URL, aria2, DOWNLOAD_DIR, download_dict, download_dict_lock, \
